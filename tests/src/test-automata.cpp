...
namespace
{
  ...
  void assert_nfa_dfa_agree(const NFA<char>& nfa, const DynArray<string>& tests)
  {
...
int main()
{
  ...
  // regex_to_nfa(): literal concatenation.
  {
    ...
    assert_nfa_dfa_agree(nfa, {string("abc"), string("ab"), string("abcd"), string("")});
  ...
  // regex_to_nfa(): alternation.
  {
    ...
    assert_nfa_dfa_agree(nfa, {string("cat"), string("dog"), string("cow"), string("catdog")});
  ...
  // regex_to_nfa(): Kleene star, plus, optional.
  {
    ...
    assert_nfa_dfa_agree(star, {string(""), string("a"), string("aaaa"), string("b")});
    ...
    assert_nfa_dfa_agree(opt, {string("color"), string("colour"), string("colouur")});
  ...
  // subset construction (Aho-Sethi-Ullman "Dragon Book").
  {
    ...
    assert_nfa_dfa_agree(nfa, {string("abb"), string("aabb"), string("babb"),
                              string("aaababb"), string("ab"), string("abbb"), string("")});
