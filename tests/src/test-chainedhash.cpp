...
int main()
{
    ...
    // Regression: SeparateChainingHashTable's default comparator
    // constructor used to bind `Cmp &cmp` straight to a temporary/
    // default-argument destroyed at the end of the constructor call
    // (see chainedhash.hpp / typetraits.hpp's DefaultCmpHolder). Every
    // HashSet used above is already exercised via
    ...
    // Regression: SeparateChainingHashTable::clear() (and, through it,
    // HashSet::clear()/HashMap::clear()) called a nonexistent
    // FixedArray::clear() after
