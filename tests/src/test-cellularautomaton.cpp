...
int main()
{
    // Conway's Game of Life: the "block" still life never changes.
    {
        ...
        cout << "CellularAutomaton: Game of Life block (still life) Everything "
                "ok!\n";
    }
    ...
    // vertical one after one generation, and back after another (period 2).
    {
        ...
        cout << "CellularAutomaton: Game of Life blinker (period-2 oscillator) "
                "Everything ok!\n";
    }
    ...
    // rule's output memorized.
    {
        ...
        cout
            << "CellularAutomaton: 1D shift rule, full period Everything ok!\n";
    }
