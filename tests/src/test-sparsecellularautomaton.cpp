...
int main()
{
    ...
    // background, exactly as it should be with no fixed grid at all.
    {
        ...
        SparseCellularAutomaton<int_t> ca(lattice, neighborhood,
                                          game_of_life_rule);
        ca.step();
        ...
        cout << "SparseCellularAutomaton: Game of Life block (still life) "
                "Everything ok!\n";
    }
    ...
    // coordinates, which a dense Lattice cannot represent at all.
    {
        ...
        cout << "SparseCellularAutomaton: Game of Life blinker (period-2, "
                "negative coords) Everything ok!\n";
    }
    ...
    // the frontier from growing without bound.
    {
        ...
        cout << "SparseCellularAutomaton: lone cell dies and prunes to empty "
                "Everything ok!\n";
    }
    ...
    // instead of ever cycling back.
    {
        ...
        SparseVonNeumannNeighborhood<int_t>
            neighborhood; // [left, right] for 1D
        ...
        cout << "SparseCellularAutomaton: 1D unbounded shift rule Everything "
                "ok!\n";
    }
    ...
    // background without creating an entry.
    {
        ...
        {
            lattice.get(
                SparseCoordinates({0, 0})); // wrong number of coordinates
        }
        ...
        cout << "SparseLattice: dimensionality/background checking Everything "
                "ok!\n";
    }
