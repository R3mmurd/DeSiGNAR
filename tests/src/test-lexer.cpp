...
int main()
{
...

    {
        ...
        cout << "Lexer: keyword vs identifier maximal-munch/tie-break "
                "Everything ok!\n";
    }

    {
        ...
        cout << "Lexer: multi-token maximal munch across a full expression "
                "Everything ok!\n";
    }
    ...
    // pattern) must throw rather than silently skip or misparse.
    {
        ...
        cout << "Lexer: unrecognized character reports a lexical error "
                "Everything ok!\n";
    }
