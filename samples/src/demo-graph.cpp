...
void write_graph(Graph& g, const char& name)
{
    ...
    cout << "graph " << name << "\n";
    cout << g.get_num_nodes() << " nodes, " << g.get_num_arcs() << " arcs\n\n";
    ...
    g.for_each_arc(
        [&](auto a)
        {
            ...
            cout << s << connector << t << "(" << a->get_info() << ")" << endl;
        });
...
int main()
{
    ...
    depth_first_traverse(i, [](auto p) { cout << p->get_info() << " "; });

    cout << endl << endl;

    cout << "Depth first traverse (suffix): ";

    depth_first_traverse_suffix(i,
                                [](auto p) { cout << p->get_info() << " "; });
    ...
    breadth_first_traverse(i, [](auto p) { cout << p->get_info() << " "; });
    ...
    depth_first_traverse(di, [](auto p) { cout << p->get_info() << " "; });

    cout << endl << endl;

    cout << "Depth first traverse (suffix): ";

    depth_first_traverse_suffix(di,
                                [](auto p) { cout << p->get_info() << " "; });
    ...
    cout << "Path between " << dn1->get_info() << " && " << dn4->get_info()
         << ": ";
    ...
    breadth_first_traverse(di, [](auto p) { cout << p->get_info() << " "; });
