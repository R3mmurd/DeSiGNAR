...
int main()
{
  ...
  nat_t num_bits = BloomFilter<string>::optimal_num_bits(expected_items, target_fp_rate);
  nat_t num_hashes = BloomFilter<string>::optimal_num_hashes(num_bits, expected_items);
