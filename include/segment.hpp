...
namespace Designar
{
    ...
    public:
        ...
        GenSegment() : src_point(), tgt_point()
        {
            // empty
        }
        ...
        GenSegment(PointT&& sp, PointT&& tp)
            : src_point(std::forward<PointT>(sp)),
              tgt_point(std::forward<PointT>(tp))
        {
            // empty
        }
        ...
        GenSegment(GenSegment&& s) : GenSegment()
        {
            swap(s);
        }
        ...
        {
            if (s.is_collinear_with(src_point) ||
                s.is_collinear_with(tgt_point) or
                is_collinear_with(s.src_point) ||
                is_collinear_with(s.tgt_point))
            {
                return false;
            }
        ...
        {
            return (src_point == s.src_point && tgt_point == s.tgt_point) or
                   (src_point == s.tgt_point && tgt_point == s.src_point);
        }
