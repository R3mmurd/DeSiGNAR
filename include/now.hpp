...
namespace Designar
{
    ...
    public:
        ...
        {
            duration_t et =
                std::chrono::duration_cast<std::chrono::nanoseconds>(rtp - ltp);
         ...
         *  @see Precision
         */
        Now(bool start_now = false) : tp(), precision(Precision::MILLISECONDS)
        {
            if (start_now)
            {
                start();
         ...
         *
         *  This method must be used before calling elapsed() or delta() the
         * first time.
         *
